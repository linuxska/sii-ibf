...
abstract class BasesfGuardUserPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::ALGORITHM, self::SALT, self::PASSWORD, self::EMAIL, self::CREATED_AT, self::LAST_LOGIN, self::IS_ACTIVE, self::IS_SUPER_ADMIN, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::ALGORITHM => 2, self::SALT => 3, self::PASSWORD => 4, self::EMAIL => 5, self::CREATED_AT => 6, self::LAST_LOGIN => 7, self::IS_ACTIVE => 8, self::IS_SUPER_ADMIN => 9, ),
